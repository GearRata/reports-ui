  ...
  useEffect(() => {
    const loadSolution = async () => {
      if (task && task.status === 1) {
        try {
          const solutionData = await getSolution(Number(taskId));
                              ...
                              {isEditingSolution ? (
                                <div className="space-y-4">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    />
                                    {editSolutionFiles.length > 0 && (
                                      <div className="mt-2">
                                        <p className="text-sm text-green-600">
                                          รูปภาพใหม่ที่เลือก:{" "}
                                          {editSolutionFiles.length} รูป
                                        </p>
                                        <div className="grid grid-cols-3 gap-2 mt-2">
                                          {editSolutionFiles.map(
                                            (file, index) => (
                                              <div
                                                key={index}
                                                className="relative aspect-square group"
                                              >
                                                <img
                                                  ...
                                                  className="w-full h-full object-cover rounded-md border border-green-300"
                                                />

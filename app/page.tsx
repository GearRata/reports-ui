        ...
        <div className="flex justify-center gap-2 md:justify-center">
          <a href="" className="flex items-center gap-2 font-medium">
            <div className="text-primary-foreground flex items-center justify-center gap-2">
              <Image src="/LOGO-NOPADOL.png" alt="Logo" width={45} height={40} className='drop-shadow-lg drop-shadow-blue-600'/>
              <h1 className='text-4xl font-bold text-blue-700 drop-shadow-lg drop-shadow-blue-600'>NOPADOL</h1>
            </div>
          </a>
        </div>
